...
| Polices | @fontsource (auto-hébergé) | 5.x |
| Icônes | lucide-react | 1.x |

Les polices sont **auto-hébergées** via `@fontsource`. Elles ne font aucun appel réseau vers Google Fonts à la construction ou à l'exécution.
...
│   ├── layout.tsx                # Layout racine (shell minimal)
│   ├── page.tsx                  # Redirection / → /fr
│   └── [locale]/                 # Routes multilingues (fr, en, it)
│       ├── layout.tsx            # Layout par locale : html, body, polices, metadata
│       ├── page.tsx              # Page d'accueil
│       ├── about/
│       │   ├── page.tsx          # Page À propos (server)
│       │   └── AboutContent.tsx  # Contenu À propos (client)
│       ├── realisations/
│       │   ├── page.tsx          # Page Réalisations (server)
│       │   └── RealisationsContent.tsx  # Sidebar + filtres + grille + modal (client)
│       └── contact/
│           ├── page.tsx          # Page Contact (server)
│           └── ContactContent.tsx # Contenu Contact (client)
│
├── components/
│   ├── layout/
...
│   │   └── CTASection.tsx
│   └── ui/
│       └── SocialIcons.tsx       # Icônes SVG LinkedIn, Facebook, Instagram
│
├── data/                         # Données structurées — modifier ici
│   ├── site.ts                   # Email, téléphone, adresse, réseaux sociaux
│   └── realisations.ts           # Toutes les réalisations du portfolio (28 pièces)
│
├── i18n/
│   ├── routing.ts                # Définition des locales (fr, en, it)
│   └── request.ts                # Configuration next-intl
│
├── messages/                     # Traductions — modifier ici
│   ├── fr.json                   # Français
│   ├── en.json                   # Anglais
│   └── it.json                   # Italien
│
├── proxy.ts                      # Proxy Next.js 16 (routage multilingue)
├── next.config.ts                # Configuration Next.js
├── tsconfig.json                 # Configuration TypeScript
│
└── public/
    ├── favicon.ico
    └── assets/                   # ← TOUTES les images du site, organisées par section
        ├── logo/                 # Logo GloriaFab (si exporté en image)
        ├── hero/                 # Vidéo et image de fond de la page d'accueil
        ├── about/                # Photos El Guettar, montagne, oasis, atelier
        ├── contact/              # Visuels liés à la page Contact (si besoin)
        └── realisations/         # ← Photos du portfolio, 1 dossier par réalisation
            ├── h001-tshirt-homme-ete/
            │   ├── 01.webp
            │   ├── 02.webp
            │   ├── 03.webp
            │   └── 04.webp
            ├── f005-robe-ete-legere/
            │   ├── 01.webp
            │   ├── 02.webp
            │   └── 03.webp
            └── ...                # 28 dossiers au total, un par réalisation
```
